...
package rearrangelinkedlistinsortedorder;
 ...
 *
 */
public class RearrangeLinkedListInGivenPlace
{
    ...
    public static void main(String[] args)
    {
        ...
        RearrangeLinkedListInGivenPlace list = new RearrangeLinkedListInGivenPlace();
